...
namespace CompanyAPI.Database.Context {
    public class CompanyApiContext : IdentityDbContext {
        ...
        public DbSet<Employee> Employees { get; set; } public DbSet<Company> Companies { get; set; } public DbSet<Address> Addresses { get; set; } public DbSet<EmployeeAddress> EmployeesAddresses { get; set; }
